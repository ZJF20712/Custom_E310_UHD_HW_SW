...
void ad9361_device_t::_calibrate_tx_quadrature()
{
     ...
     * restore it later. */
    uint8_t orig_reg_inputsel = 0x03;
...
double ad9361_device_t::_tune_helper(direction_t direction, const double value)
{
    ...
    if (direction == RX) {
       ...
       //_regs.inputsel = (_regs.inputsel & 0xC0) | 0x03; // Only Use Port A, balanced
	_regs.inputsel = 0x03;
...
void ad9361_device_t::initialize()
{
    ...
    set_active_chains(false, true, false, false);
 ...
 *  RX2             Side B              RX2
 */
void ad9361_device_t::set_active_chains(bool tx2, bool tx1, bool rx2, bool rx1)
{
    std::lock_guard<std::recursive_mutex> lock(_mutex);
