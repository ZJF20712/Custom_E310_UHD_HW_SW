...
def read_eeprom(
    ...
    if is_motherboard: # E310 MB.
        ...
        parsed_data_list[0] = 0x0001
        parsed_data_list[1] = 0x0001
        parsed_data_list[2] = b"x\a0x\11x\45x\14x\19x\19"
        parsed_data_list[3] = 0x77D3
        parsed_data_list[4] = 0x0101
        # Some revisions use xFF terminated strings for serial and user_name.
        parsed_data_list[5] = b"114514"
        parsed_data_list[6] = b"x\00"
        parsed_data_list[7] = b"Fan>_<"
        parsed_data = tuple(parsed_data_list)
        data = eeprom_parser.pack(*parsed_data_list)
        ...
        parsed_data_list[0] = 0x0001
        parsed_data_list[1] = 0x0001
        parsed_data_list[2] = 0x0110
        parsed_data_list[3] = 0x0101
        # Some revisions use xFF terminated strings for serial.
        # Replace xFF with NULL to pass ascii conversion.
        parsed_data_list[4] = b"114514"
        parsed_data_list[5] = b"x\00"
        parsed_data = tuple(parsed_data_list)
        data = eeprom_parser.pack(*parsed_data_list)
