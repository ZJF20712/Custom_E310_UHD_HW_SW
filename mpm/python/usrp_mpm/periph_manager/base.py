...
class PeriphManagerBase:
    ...
    def _get_mboard_info(self):
        ...
        if not hasattr(self, "_eeprom_head"):
            ...
            self.log.debug("Read Mboard EEPROM Done")
    ...
    def _get_dboard_info_legacy(self):
        ...
        dboard_eeprom_paths = []
        self.log.debug("Identifying dboard EEPROM paths from addrs `{}'..."
        ...
        dboard_eeprom_paths = dboard_eeprom_addrs
        self.log.debug("Found dboard EEPROM paths: {}"
        ...
        for dboard_idx, dboard_eeprom_path in enumerate(dboard_eeprom_paths):
            ...
            self.log.debug("Found dboard EEPROM metadata: `{}'"
                           .format(str(dboard_eeprom_md)))
            self.log.debug("Read %d bytes of dboard EEPROM data.",
