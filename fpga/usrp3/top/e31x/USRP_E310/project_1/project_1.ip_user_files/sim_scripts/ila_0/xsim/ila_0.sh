...
# Set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_13 -L processing_system7_vip_v1_0_15 -L smartconnect_v1_0 -L xilinx_vip"
...
simulate()
{
  xsim  ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_cc08.protoinst" -protoinst "protoinst_files/e31x_ps_bd.protoinst" -log simulate.log
}
