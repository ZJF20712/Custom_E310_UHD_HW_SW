...
HD_PWD='G:/FPGA/Vivado_Prj/USRP_E310/project_1/project_1.runs/e31x_ps_bd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e31x_ps_bd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e31x_ps_bd_xbar_0.tcl
