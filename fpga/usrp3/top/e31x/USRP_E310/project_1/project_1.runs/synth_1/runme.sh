...
HD_PWD='G:/FPGA/Vivado_Prj/USRP_E310/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e31x_idle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e31x_idle.tcl
