...
HD_PWD='G:/FPGA/Vivado_Prj/USRP_E310/project_1/project_1.runs/impl_1_idle'
cd "$HD_PWD"
...
EAStep vivado -log e31x_idle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source e31x_idle.tcl -notrace
