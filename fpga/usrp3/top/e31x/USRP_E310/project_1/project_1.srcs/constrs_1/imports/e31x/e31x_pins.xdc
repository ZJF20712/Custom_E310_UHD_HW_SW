...
#Pin 35
set_property PACKAGE_PIN W11 [get_ports {CAT_CTRL_IN[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_IN[2]}]
...
#Pin 37
set_property PACKAGE_PIN Y9 [get_ports {CAT_CTRL_IN[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_IN[3]}]
...
#Pin 39
set_property PACKAGE_PIN Y8 [get_ports {CAT_CTRL_OUT[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_OUT[0]}]

#Pin 40
set_property PACKAGE_PIN Y11 [get_ports {CAT_CTRL_OUT[4]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_OUT[4]}]

#Pin 41
set_property PACKAGE_PIN Y7 [get_ports {CAT_CTRL_OUT[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_OUT[1]}]

#Pin 42
set_property PACKAGE_PIN V10 [get_ports {CAT_CTRL_OUT[5]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_OUT[5]}]

#Pin 43
set_property PACKAGE_PIN Y6 [get_ports {CAT_CTRL_OUT[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_OUT[2]}]

#Pin 44
set_property PACKAGE_PIN W6 [get_ports {CAT_CTRL_OUT[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_OUT[6]}]

#Pin 45
set_property PACKAGE_PIN W8 [get_ports {CAT_CTRL_OUT[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_OUT[3]}]

#Pin 46
set_property PACKAGE_PIN V6 [get_ports {CAT_CTRL_OUT[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_OUT[7]}]
...
#Pin 48
set_property PACKAGE_PIN U10 [get_ports CAT_RESET]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_RESET]

#Pin 49
# 1.8V

#Pin 50
set_property PACKAGE_PIN Y12 [get_ports CAT_CS]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_CS]

#Pin 51
# 1.8V
#Pin 52
set_property PACKAGE_PIN U9 [get_ports CAT_SCLK]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_SCLK]

#Pin 53
# 5V

#Pin 54
set_property PACKAGE_PIN U8 [get_ports CAT_MOSI]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_MOSI]

#Pin 55
# 5V

#Pin 56
set_property PACKAGE_PIN V11 [get_ports CAT_MISO]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_MISO]

#Pin 57
# 5V

#Pin 58
set_property PACKAGE_PIN W10 [get_ports {CAT_CTRL_IN[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_IN[0]}]

#Pin 59
# 5V

#Pin 60
set_property PACKAGE_PIN U5 [get_ports {CAT_CTRL_IN[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_CTRL_IN[1]}]
...
#Pin 67
set_property PACKAGE_PIN V7 [get_ports CAT_TXNRX]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_TXNRX]

#Pin 68
# GND

#Pin 69
set_property PACKAGE_PIN T5 [get_ports CAT_ENABLE]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_ENABLE]

#Pin 70
set_property PACKAGE_PIN U7 [get_ports CAT_BBCLK_OUT]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_BBCLK_OUT]

#Pin 71
set_property PACKAGE_PIN T9 [get_ports CAT_ENAGC]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_ENAGC]
...
#Pin 74
set_property PACKAGE_PIN V8 [get_ports CAT_SYNC]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_SYNC]

#Pin 78
set_property PACKAGE_PIN V17 [get_ports {CAT_P1_D[11]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[11]}]

#Pin 76
# GND

#Pin 100
set_property PACKAGE_PIN V18 [get_ports {CAT_P1_D[10]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[10]}]

#Pin 93
set_property PACKAGE_PIN T17 [get_ports {CAT_P0_D[11]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[11]}]

#Pin 96
set_property PACKAGE_PIN T20 [get_ports {CAT_P1_D[9]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[9]}]

#Pin 95
set_property PACKAGE_PIN R18 [get_ports {CAT_P0_D[10]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[10]}]

#Pin 98
set_property PACKAGE_PIN U20 [get_ports {CAT_P1_D[8]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[8]}]

#Pin 81
set_property PACKAGE_PIN V12 [get_ports {CAT_P0_D[9]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[9]}]

#Pin 92
set_property PACKAGE_PIN V20 [get_ports {CAT_P1_D[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[7]}]

#Pin 97
set_property PACKAGE_PIN W13 [get_ports {CAT_P0_D[8]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[8]}]

#Pin 94
set_property PACKAGE_PIN W20 [get_ports {CAT_P1_D[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[6]}]

#Pin 77
set_property PACKAGE_PIN U14 [get_ports {CAT_P0_D[7]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[7]}]

#Pin 86
set_property PACKAGE_PIN Y18 [get_ports {CAT_P1_D[5]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[5]}]

#Pin 85
set_property PACKAGE_PIN U15 [get_ports {CAT_P0_D[6]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[6]}]

#Pin 90
set_property PACKAGE_PIN Y19 [get_ports {CAT_P1_D[4]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[4]}]

#Pin 75
set_property PACKAGE_PIN R16 [get_ports {CAT_P0_D[5]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[5]}]

#Pin 82
set_property PACKAGE_PIN Y16 [get_ports {CAT_P1_D[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[3]}]

#Pin 91
set_property PACKAGE_PIN R17 [get_ports {CAT_P0_D[4]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[4]}]

#Pin 88
set_property PACKAGE_PIN Y17 [get_ports {CAT_P1_D[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[2]}]

#Pin 79
set_property PACKAGE_PIN P15 [get_ports {CAT_P0_D[3]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[3]}]

#Pin 80
set_property PACKAGE_PIN V16 [get_ports {CAT_P1_D[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[1]}]

#Pin 89
set_property PACKAGE_PIN P16 [get_ports {CAT_P0_D[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[2]}]

#Pin 84
set_property PACKAGE_PIN W16 [get_ports {CAT_P1_D[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P1_D[0]}]

#Pin 83
set_property PACKAGE_PIN T14 [get_ports {CAT_P0_D[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[1]}]

#Pin 102
set_property PACKAGE_PIN W14 [get_ports CAT_TX_FRAME]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_TX_FRAME]

set_property PACKAGE_PIN Y14 [get_ports CAT_TX_FRAME_N]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_TX_FRAME_N]

#Pin 87
set_property PACKAGE_PIN T15 [get_ports {CAT_P0_D[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {CAT_P0_D[0]}]

#Pin 104
set_property PACKAGE_PIN U18 [get_ports CAT_FB_CLK]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_FB_CLK]

set_property PACKAGE_PIN U19 [get_ports CAT_FB_CLK_N]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_FB_CLK_N]

#Pin 99
set_property PACKAGE_PIN N17 [get_ports CAT_RX_FRAME]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_RX_FRAME]

#Pin 103
# GND

#Pin 101
set_property PACKAGE_PIN N18 [get_ports CAT_DATA_CLK]
set_property IOSTANDARD LVCMOS25 [get_ports CAT_DATA_CLK]
